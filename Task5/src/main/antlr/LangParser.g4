...
stringExpression : STRINGLIT # stringLiteral ;
...
binaryArithmeticSign : PLUS | MINUS | ASTERISK | DIVISION | PERCENT ;

comparisonSign : EQUAL | NOTEQUAL | GREATER | GREATEROREQ | LESS | LESSOREQ ;
